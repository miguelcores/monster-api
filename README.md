...
**Monster routes**:\
`POST /v1/monsters` - create a monster\
`GET /v1/monsters` - get all monsters\
`GET /v1/monsters/:monsterId` - get monster\
`PUT /v1/monsters/:monsterId` - update monster (e.g., add gold)\
`PATCH /v1/monsters/:monsterId` - get monster gold\
`DELETE /v1/monsters/:monsterId` - delete monster

`PUT /v1/monsters/:monsterId/like` - like monster\
`GET /v1/monsters/:monsterId/like` - get monsters sorted by number of likes\
...
The app also contains 2 custom mongoose plugins that you can attach to any mongoose model schema.
