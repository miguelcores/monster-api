...
describe('User routes', () => {
  describe('POST /v1/users', () => {
    ...
    test('should return 403 error if logged in user is not superAdmin', async () => {
    ...
    test('should return 400 error if role is neither user nor superAdmin', async () => {
      await insertUsers([superAdmin]);
  ...
  describe('GET /v1/users', () => {
    test('should return 200 and apply the default query options', async () => {
      ...
      delete res.body.results[0].goldBalance;
    ...
    test('should return 403 if a non-superAdmin is trying to access all users', async () => {
      await insertUsers([userOne, userTwo, superAdmin]);
  ...
  describe('DELETE /v1/users/:userId', () => {
    ...
    test('should return 204 if superAdmin is trying to delete another user', async () => {
      await insertUsers([userOne, superAdmin]);
  ...
  describe('PATCH /v1/users/:userId', () => {
    ...
    test('should return 200 and successfully update user if superAdmin is updating another user', async () => {
      await insertUsers([userOne, superAdmin]);
      const updateBody = { name: faker.name.findName() };
    ...
    test('should return 404 if superAdmin is updating another user that is not found', async () => {
      await insertUsers([superAdmin]);
      const updateBody = { name: faker.name.findName() };
